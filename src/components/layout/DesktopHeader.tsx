...
export default function DesktopHeader() {
  ...
  return (
    <header className={`hidden lg:block fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled
      ? "py-3.5 bg-[#02040a]/95 backdrop-blur-md shadow-[0_4px_30px_rgba(59,130,246,0.1)] border-b border-[#3b82f6]/20"
      ...
      <Container>
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex items-center shrink-0">
            <Link href="/">
              <Image
                src={myLogo}
                alt="Infocart Logo"
                className={`h-auto object-contain origin-left opacity-90 hover:opacity-100 transition-all duration-300 ${isScrolled ? "w-[140px]" : "w-[170px]"
                  }`}
                priority
              />
            </Link>
          ...
          <div className="flex items-center gap-6 shrink-0">
            <button className="font-geist px-6 py-2.5 rounded-full bg-[#3b82f6] text-white text-[13px] font-semibold tracking-wide hover:bg-blue-600 hover:shadow-lg hover:-translate-y-0.5 transition-all whitespace-nowrap">
              Get a Quote
            </button>

            <a href="https://wa.me/97143411140" target="_blank" rel="noreferrer" className="hidden xl:flex items-center gap-2 group cursor-pointer">
              <svg className="w-6 h-6 text-[#25D366] hover:scale-110 transition-transform origin-center" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-[13px] font-semibold tracking-tight font-geist transition-colors text-white group-hover:text-slate-300">+971 43411140</span>
            </a>
          </div>
        </div>
      </Container>
